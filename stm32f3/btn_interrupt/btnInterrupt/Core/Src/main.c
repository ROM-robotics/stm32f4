...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	EXTI_ConfigTypeDef user_btn;
	user_btn.GPIOSel = EXTI_GPIOA;
	user_btn.Line = EXTI_LINE_0;
	user_btn.Trigger = EXTI_TRIGGER_RISING;
	
	EXTI_HandleTypeDef user_btn_handle;
	user_btn_handle.Line = 
  /* USER CODE END 2 */
